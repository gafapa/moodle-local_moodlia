...
The screenshots show that validation run. Release 0.1.215 uses the same web
...
- The site runs Moodle 4.5, 5.0, 5.1, 5.2, or 5.3.
...
```text
empaquetado/local_moodlia-0.1.215.zip
```
...
The `MATURITY_BETA` message is informational for release 0.1.215. Stop if the
...
8. On **Plugins check**, confirm the following row before changing the
   ...
   - Required Moodle range: `405 - 503` for release 0.1.215
...
- Release: `0.1.215`, or the release you installed
- Version: `2026092400`, or the version declared by that release
- Source: **Additional**
...
Match the target Moodle release against `version.php`. MoodlIA 0.1.215 declares

...
- Supported Moodle versions: 4.5 LTS to 5.3
- Release: 0.1.213
...
Upload `local_moodlia-0.1.213.zip` through Moodle's plugin installer or extract
...
- Upload `empaquetado/local_moodlia-0.1.213.zip`.

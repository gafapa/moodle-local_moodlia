...
/**
 * Create grouping external function.
 *
...
use local_moodlia\operation\create_grouping as create_grouping_operation;
...
class create_grouping extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'description' => new external_value(PARAM_RAW, 'Grouping description', VALUE_DEFAULT, ''),
            'idnumber' => new external_value(PARAM_RAW, 'Grouping idnumber', VALUE_DEFAULT, ''),
        ]);
    }

...
/**
 * List folder files external function.
 *
...
use local_moodlia\operation\get_folder_files as get_folder_files_operation;

/**
 * External API adapter for get_folder_files.
 */
class get_folder_files extends external_api {
    /**
    ...
    public static function execute(int $courseid, int $moduleid): array {
        ...
        return get_folder_files_operation::execute((int) $courseid, (int) $moduleid);
    }

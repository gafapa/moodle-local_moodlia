...
/**
 * Create workshop submission external function.
 *
...
use local_moodlia\operation\create_workshop_submission as create_workshop_submission_operation;
use local_moodlia\operation\workshop_tools;

/**
 * External API adapter for create_workshop_submission.
 */
class create_workshop_submission extends external_api {
    /**
    ...
    public static function execute(
        ...
        return create_workshop_submission_operation::execute(
            (int) $courseid,
            (int) $moduleid,
            $title,
            $content,

...
/**
 * Get Glossary entries by category external function.
 *
...
use local_moodlia\operation\get_glossary_entries_by_category as get_glossary_entries_by_category_operation;

/**
 * External API adapter for get_glossary_entries_by_category.
 */
class get_glossary_entries_by_category extends external_api {
    /**
     * Execute parameters.
     *
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'category_id' => new external_value(PARAM_INT, 'Category id, 0 for all, or -1 for uncategorised', VALUE_DEFAULT, 0),
    ...
    public static function execute(
        ...
        return get_glossary_entries_by_category_operation::execute(
            (int) $courseid,
            (int) $moduleid,
            (int) $categoryid,
            (int) $from,
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'category_id' => new external_value(PARAM_INT, 'Requested category id'),
        ]);
    }
}

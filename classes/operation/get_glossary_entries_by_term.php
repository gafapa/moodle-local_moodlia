...
/**
 * Get Glossary entries by term operation.
 *
...
/**
 * Lists Glossary entries by term through Moodle Glossary external APIs.
 */
class get_glossary_entries_by_term {
    /**
    ...
    public static function execute(
        ...
        $result = \mod_glossary_external::get_entries_by_term(
            (int) $cm->instance,
            $term,
            max(0, $from),
            max(1, $limit),
